          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/3">
                <Image src="/3.jpg" alt="Harry as a beginner" className="w-full rounded-lg shadow-lg" width={500} height={300} />
              </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/3">
                <Image src="/2.jpg" width={500} height={300} alt="Harry learning new skills" className="w-full rounded-lg shadow-lg" />
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/3">
                <Image src="/1.jpg" width={500} height={300} alt="Harry working on a big project" className="w-full rounded-lg shadow-lg" />
              </div>
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/3">
                <Image src="/4.jpg" width={500} height={300} alt="Harry mentoring others" className="w-full rounded-lg shadow-lg" />
              </div>
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
